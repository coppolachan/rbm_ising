...
for epoch in pbar:
    ...
    dream = rbm.sample_from_rbm(10000, 10, temperature=0.0, decay=0.00)
    imgshow(args.image_output_dir + "dream" + str(epoch),
            make_grid(dream.view(-1, 1, image_size, image_size).data))
